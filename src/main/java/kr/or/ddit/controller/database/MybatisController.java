...
public class MybatisController {
	 ...
	 * 			- 여기까지 확인
	 * 
	 *  		- 게시판 삭제 기능 컨트롤러 메소드 만들기(crudModify:get)
	 ...
	 *      
	 *  5. 기본키 취득
	 *  - 마이바티스는 useGeneratedKeys 속성을 이용하여 insert할 때 데이터 베이스 측에서 채번된 키본키를 취득할 수 있다.
	 *  
	 *  	1) 마이바티스 설정
	 *  	
	 ...
	 *  
	 *  				# 그럼에도 나는 가져와야겠다! 다 필요 없고 걍 내놔! 하고 싶으면
	 ...
	 *  	1) 게시판 구현 설명
	 *  
	 *  		- 회원 등록 화면 컨트롤러 만들기(member/CurdmemberController)
	 *  		- 회원 등록 화면 컨트롤러 메소드 만들기(curdMemberRegisterForm:get)
	 ...
	 * 		    우리는 그러한 공통 부들을 분리하여 반복적으로 컴포넌트들을 사용하는게 아니라 공통적인 부분은 한번만 가져다 쓰고
	 ...
	 * 
	 * 		** 모듈화를 진행할 페이지
	 * 		- template.jsp (메인으로 사용하게 될 템플릿 페이지 입니다)
	 * 		- header.jsp (header 영역에서 사용할 페이지 입니다)
	 * 		- content source (body 영역에서 사용할 동적으로 변화될 페이지입니다)
	 * 		- fotter.jsp (footer 영역에서 사용할 페이지입니다)
	 * 			
