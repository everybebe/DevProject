...
public class BoardController {
	...
	public void registerForm() {
		logger.info("registerForm() 실행...!!!!!!!"); //로그레벨이 info인 메세지 출력 
	}
...
//	
	...
	public String registerParamPost() {
		logger.info("registerParamPost() 실행...!");
		return "board/list";
	}
	...
	// 응답 상태 코드와 값을 제네릭에 설정되어 있는 타입에 따라서 내 마음대로 내보낼 수 있다.
	// 응답 상태 코드 : HttpStatus라는 객체 안에 있는 여러 상태 코드를 선택해서 내보낼 수 있다.
	// 결과 값 : 제네릭 타입에 설정되어 있는 해당 타입의 값으로 결과의 값을 설정해서 내보낼 수 있다.
