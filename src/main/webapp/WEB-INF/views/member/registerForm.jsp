...
<body>
	...
	<p>3) 여러 개의 폼 텍스트 필드 요서값을 매개변수 순서와 상관없이 매개변수명을 기준으로 처리한다.</p>
	...
	<a href="/registerByGet01?userId=hongkd&dataOfBirth=2018-09-08">BUTTON05</a>

	<p>3) 쿼리파라미터(dateOfBirth=20180908)로 전달받은 값이 날짜 문자열 형식으로 설정 시, Date 타입으로 받는가?</p>
	<a href="registerByGet01?userId=hongkd&dateOfBirth=20190908">BUTTON06</a>
	
	<p>4) 쿼리파라미터(dateOfBirth=2018/09/08)로 전달받은 값이 날짜 문자열 형식으로 설정 시, Date 타입으로 받는가?<br>
	...
	<p>6) Member 매개변수와 폼 방식 요청 전달 받은 값이 날짜 문자열 형식으로 설정 시, Date 타입으로 받는가?</p>
	<form action="/register" method="post">
		userId : <input type="text" name="userId" value="hongkd"><br>
		password : <input type="text" name="password" value="1234"><br>
		dateOfBirth : <input type="text" name="dateOfBirth" value="20190908"><br>
	...
	<p>3) 폼 비밀번호 요소값을 자바빈즈 매개변수로 처리한다. </p>
	...
	<p>7) 복수 선택이 가능한 폼 셀렉트 박스 요소값을 기본 문자열 배열 타입 매개변수로 처리한다.</p>
	...
	<form action="/registerFile06" method="post" enctype="multipart/form-data">
		userId : <input type="text" name="userId" value="hongkd"/>
		password : <input type="text" name="password" value="1234"/><br>
		<input type="file" name="picturList[0]" />
		<input type="file" name="picturList[1]" />
		<input type="submit" value="업로드" />
	</form><br>
