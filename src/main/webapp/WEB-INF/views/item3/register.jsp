...
$(function(){
	...
	//Open파일을 변경했을 때 발동  , 파일을 선택했을 때 실행
	inputFile.on("change", function(event){
		...
		$.ajax({
			...
			success: function(data) {
				...
				var str = "";
				if(checkImageType(data)){  //이미지인지 아닌지 확인, 이미지면 이미지태그를 이용하여 출력
					str += "<div>";
	...
	function getOriginalName(fileName){
		...
		if(checkImageType(fileName)){  //이미지면 리턴
			return;
		}
